...
dagcomponentfuncs.TeamCommitmentBar = function(props) {
    ...
    return React.createElement('div', {
        ...
        React.createElement('div', {
            key: 'track',
            style: {flex:1, height:'5px', background:'#e5e5ea',
                    borderRadius:'3px', overflow:'hidden', minWidth:'30px'}
        }, React.createElement('div', {
        ...
        React.createElement('span', {
            key: 'label',
            style: {fontSize:'10px', color:'#8e8e93', whiteSpace:'nowrap',
